...
impl CefWindowInfo {
    ...
    pub fn x(&self) -> std::os::raw::c_int { self.raw.x }
    pub fn y(&self) -> std::os::raw::c_int { self.raw.y }
    pub fn width(&self) -> std::os::raw::c_int { self.raw.width }
    pub fn height(&self) -> std::os::raw::c_int { self.raw.height }
    pub fn parent_window(&self) -> cef_sys::HWND { self.raw.parent_window }
    pub fn menu(&self) -> cef_sys::HMENU { self.raw.menu }
    pub fn windowless_rendering_enabled(&self) -> std::os::raw::c_int { self.raw.windowless_rendering_enabled }
    pub fn shared_texture_enabled(&self) -> std::os::raw::c_int { self.raw.shared_texture_enabled }
    pub fn external_begin_frame_enabled(&self) -> std::os::raw::c_int { self.raw.external_begin_frame_enabled }
    ...
    pub fn set_x(&mut self, v: std::os::raw::c_int) -> &mut Self { self.raw.x = v; self }
    pub fn set_y(&mut self, v: std::os::raw::c_int) -> &mut Self { self.raw.y = v; self }
    pub fn set_width(&mut self, v: std::os::raw::c_int) -> &mut Self { self.raw.width = v; self }
    pub fn set_height(&mut self, v: std::os::raw::c_int) -> &mut Self { self.raw.height = v; self }
    ...
    pub fn set_windowless_rendering_enabled(&mut self, v: std::os::raw::c_int) -> &mut Self { self.raw.windowless_rendering_enabled = v; self }
    pub fn set_shared_texture_enabled(&mut self, v: std::os::raw::c_int) -> &mut Self { self.raw.shared_texture_enabled = v; self }
    pub fn set_external_begin_frame_enabled(&mut self, v: std::os::raw::c_int) -> &mut Self { self.raw.external_begin_frame_enabled = v; self }
