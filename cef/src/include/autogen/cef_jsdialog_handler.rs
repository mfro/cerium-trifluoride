...
unsafe extern "C" fn cef_jsdialog_handler_t_on_jsdialog(_self: *mut cef_sys::cef_jsdialog_handler_t, browser: *mut cef_sys::cef_browser_t, origin_url: *const cef_sys::cef_string_t, dialog_type: cef_sys::cef_jsdialog_type_t, message_text: *const cef_sys::cef_string_t, default_prompt_text: *const cef_sys::cef_string_t, callback: *mut cef_sys::cef_jsdialog_callback_t, suppress_message: *mut i32) -> i32 {
  ...
  let ret = CefJSDialogHandler::from_cef(_self, true).get().on_jsdialog(crate::include::CefBrowser::from_cef_own(browser).unwrap(),match &crate::include::internal::CefString::from_cef(origin_url) { Some(ref x) => Some(x), None => None },dialog_type.into(),match &crate::include::internal::CefString::from_cef(message_text) { Some(ref x) => Some(x), None => None },match &crate::include::internal::CefString::from_cef(default_prompt_text) { Some(ref x) => Some(x), None => None },crate::include::CefJSDialogCallback::from_cef_own(callback).unwrap(),&mut suppress_message__tmp,);
