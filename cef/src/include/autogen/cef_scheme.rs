...
unsafe extern "C" fn cef_scheme_handler_factory_t_create(_self: *mut cef_sys::cef_scheme_handler_factory_t, browser: *mut cef_sys::cef_browser_t, frame: *mut cef_sys::cef_frame_t, scheme_name: *const cef_sys::cef_string_t, request: *mut cef_sys::cef_request_t) -> *mut cef_sys::cef_resource_handler_t {
  let ret = CefSchemeHandlerFactory::from_cef(_self, true).get().create(crate::include::CefBrowser::from_cef_own(browser),crate::include::CefFrame::from_cef_own(frame),&crate::include::internal::CefString::from_cef(scheme_name).unwrap(),crate::include::CefRequest::from_cef_own(request).unwrap(),);
...
pub fn cef_register_scheme_handler_factory(scheme_name: &crate::include::internal::CefString, domain_name: Option<&crate::include::internal::CefString>, factory: Option<crate::include::CefSchemeHandlerFactory>, ) -> bool {
  unsafe {
    let ret = cef_sys::cef_register_scheme_handler_factory(crate::include::internal::IntoCef::into_cef(scheme_name),crate::include::internal::IntoCef::into_cef(domain_name),factory.map_or(std::ptr::null_mut(), |o| crate::include::CefSchemeHandlerFactory::to_cef_own(o)),);
    if ret == 0 { false } else { true }
  }
}
